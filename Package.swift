...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "CVero",
            url: "https://github.com/calmdocs/vero/releases/download/v0.7.1/CVero.xcframework.zip",
            checksum: "e476618a03da2dc990ac09416fc4b8ee2e40e72ce8f5730f7f62c4ce2be465c4"
        ),
