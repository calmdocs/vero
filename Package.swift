...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "CVero",
            url: "https://github.com/calmdocs/vero/releases/download/v0.2.0/CVero.xcframework.zip",
            checksum: "513a26138c8e4f3bbc84bba63fc40884474ff8d144954ead086db13cf78c1afd"
        ),
