...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "CVero",
            url: "https://github.com/calmdocs/vero/releases/download/v0.7.2/CVero.xcframework.zip",
            checksum: "f4a757e395fe4fe307066650787c4676433455dbfbbab00b63cbf9933f619328"
        ),
